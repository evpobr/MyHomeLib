...
uses
  ...
  Dialogs, VirtualTrees, RzButton, ExtCtrls, RzPanel,globals;
...
type
  ...
  public
    ...
    procedure SelectGenres(Code:widestring);
  end;
...
procedure TfrmGenreTree.SelectGenres(Code:widestring);
var
  Node:PVirtualNode;
  Data:PGenreData;
begin
