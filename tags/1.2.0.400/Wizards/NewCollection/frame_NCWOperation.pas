...
resourcestring
  ...
  CREATENEW = 'Создать новую коллекцию. Такой тип коллекций лучше всего подходит для хранения книг, полученных из различных источников.';
  ADDEXISTS = 'Подключить ранее созданную коллекцию.';
